...
const featureBase = [
  ...
  { api: "dominates · join · meet", title: "Security labels", desc: "Dominance over (level, compartments) pairs. Incomparable labels deny in both directions — the partial order is property-tested." },
...
export const apiRows = [
  { call: "decide", color: "oklch(0.75 0.14 150)", when: "You need the full decision — trace, visible fields, obligations.", returns: "Decision", denial: "Carried in the Decision" },
  { call: "check", color: "oklch(0.75 0.14 150)", when: "A plain yes/no gate, and the policy carries no obligation.", returns: "boolean", denial: "false" },
...
export const bars = [
  ...
  { label: "merge gates passing", value: "21 / 21", width: "100%" },
  { label: "circular imports", value: "0", width: "2%" },
];
...
export const arch = [
  ...
  },
  {
    ...
    svc2: ["– skipped (short-circuit)", "oklch(0.5 0.01 260)"],
    ...
    trace: [
      ...
      ["② hasPermission(doc:read)  →  never evaluated", "oklch(0.5 0.01 260)"],
