...
| [24 — The Decision Sink](behaviors/24-decision-sink.md) | BEH-QD-181–186 | `packages/core/src/{DecisionRecord,DecisionSink,DecisionSinkRing,Evaluate}.ts` |
...
| `packages/http/test/http.test.ts` | BEH-QD-174–180, INV-QD-006, INV-QD-034 |
