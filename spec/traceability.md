...
| [31 — Predicate Compilation](behaviors/31-predicate-compilation.md) | BEH-QD-236–244 | `packages/predicate-sql/src/index.ts`, `packages/predicate-prisma/src/index.ts` |
...
| [INV-QD-054](invariants.md#inv-qd-054-verifychainintegrity-detects-every-gap-and-duplicate-sequence-number) | `verifyChainIntegrity` detects every gap and duplicate sequence number | sorts defined sequence numbers, fails on the first that is not exactly one more than its predecessor | `packages/audit/test/ChainIntegrity.test.ts` (property over generated contiguous/gapped sequences) |
...
| [ADR-QD-056](decisions/056-audit-companion-package.md) | `@qadi/audit`: a companion package narrows ADR-QD-016 | [INV-QD-051](invariants.md#inv-qd-051-staging-presence-or-absence-never-changes-the-committed-audit-entries), [INV-QD-052](invariants.md#inv-qd-052-once-a-circuit-breaker-trips-write-is-never-attempted-again-until-reset), [INV-QD-053](invariants.md#inv-qd-053-retained-and-purged-partition-entries), [INV-QD-054](invariants.md#inv-qd-054-verifychainintegrity-detects-every-gap-and-duplicate-sequence-number), [INV-QD-055](invariants.md#inv-qd-055-signatureobligationhandler-calls-capture-exactly-once-and-the-obligationrecord-matches) |
...
| `packages/core/test/Predicate.test.ts` | BEH-QD-121–128, BEH-QD-248, INV-QD-006, INV-QD-011, INV-QD-018, INV-QD-050 |
...
| `packages/testing/test/TestLayers.test.ts` | Test fixtures and layers, BEH-QD-246, BEH-QD-247, INV-QD-014, INV-QD-049 |
...
| `packages/predicate-sql/test/Agreement.test.ts` | BEH-QD-241, BEH-QD-244, INV-QD-047 |
| `packages/predicate-sql/test/CompileSql.test.ts` | BEH-QD-236–240, BEH-QD-244 |
| `packages/predicate-sql/test/Metrics.test.ts` | BEH-QD-236 |
| `packages/predicate-prisma/test/Agreement.test.ts` | BEH-QD-242, BEH-QD-244, INV-QD-048 |
| `packages/predicate-prisma/test/CompilePrismaWhere.test.ts` | BEH-QD-236, BEH-QD-238, BEH-QD-239, BEH-QD-244 |
...
| `packages/audit/test/ChainIntegrity.test.ts` | BEH-QD-254, INV-QD-054 |
