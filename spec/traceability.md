...
| [07 — Enforcement](behaviors/07-enforcement.md) | BEH-QD-049–055 | `packages/core/src/Qadi.ts`, `Errors.ts` |
...
| [27 — The Devtools Timeline](behaviors/27-devtools-timeline.md) | BEH-QD-203–210 | `packages/devtools/src/model/{Source,Timeline,TimelineStore,Verdict,Pairing,Inspect,Filters,Selection}.ts`, `packages/devtools/src/react/*` |
| [28 — The Devtools Screens](behaviors/28-devtools-screens.md) | BEH-QD-211–218 | `packages/devtools/src/model/{Catalogue,RoleTree,Wiring}.ts`, `packages/devtools/src/react/{PolicyTree,PolicyExplorer,RoleViewer,ServicesPanel,QuestionsPanel}.tsx` |
...
| `packages/devtools/test/model/Source.test.ts` | BEH-QD-203, BEH-QD-204 |
