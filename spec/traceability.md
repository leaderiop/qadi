...
| [05 — Evaluator](behaviors/05-evaluator.md) | BEH-QD-033–040, BEH-QD-261 | `packages/core/src/Evaluate.ts`, `Decision.ts` |
...
| [19 — Decision Hydration](behaviors/19-hydration.md) | BEH-QD-145–152, BEH-QD-230–232, BEH-QD-259 | `packages/react/src/Hydration.ts`, `HydrationSeed.ts`, `HydrationWarning.ts`, `HydrationCounts.ts`, `QadiAtoms.ts`, `packages/core/src/HydrationMetrics.ts`, `packages/core/src/DecodeDepthGuard.ts`, `packages/devtools/src/model/Hydration.ts` |
...
| [23 — HTTP Enforcement](behaviors/23-http.md) | BEH-QD-174–180, BEH-QD-260 | `packages/http/src/{RequirePermission,GuardRoute,SubjectExtractor,PermissionRegistry,QadiHttpError,DecisionStreamRoute}.ts` |
...
| [31 — Predicate Compilation](behaviors/31-predicate-compilation.md) | BEH-QD-236–244, BEH-QD-258 | `packages/predicate-sql/src/index.ts`, `packages/predicate-prisma/src/index.ts` |
...
| [INV-QD-006](invariants.md#inv-qd-006-failure-is-not-denial) | Failure is not denial | Effect error channel; `Evaluate.ts`'s five port calls `Effect.catchCause` a defect into that port's own typed error (BEH-QD-261); `SubjectSet.ts`'s `decideSubjects`/`filterSubjects` report a subject's failure in `failures`, never as a `Deny` (BEH-QD-262) | `Evaluate.test.ts`, `Policies.test.tsx`, `port-calls.feature`, `SubjectSet.test.ts`, `subject-sets.feature` |
...
| [INV-QD-050](invariants.md#inv-qd-050-a-hascustom-node-never-appears-in-a-compiled-predicate) | A `HasCustom` node never appears in a compiled `Predicate` | `translateNode`'s `HasCustom` arm calls `untranslatable` unconditionally | `Predicate.test.ts` |
...
| `packages/core/test/AuthSubject.test.ts` | `makeSubject`/`fromRoles`/`withAttributes`'s copy-on-build guarantee |
| `packages/http/test/v4-http-smoke.test.ts` | `effect/unstable/http`/`effect/unstable/httpapi` API canary |
| `packages/core/test/AttributeResolver.test.ts` | `attributeResolverRetrying`'s own depth — the one export `Layers.test.ts`'s happy-path pass does not otherwise exercise |
...
| `packages/core/test/Policy.test.ts` | BEH-QD-017–019, BEH-QD-057–059, BEH-QD-074, BEH-QD-081, BEH-QD-091–092, BEH-QD-245, INV-QD-003 |
...
| `packages/core/test/Evaluate.test.ts` | BEH-QD-033–040, BEH-QD-073–078, BEH-QD-081–086, BEH-QD-089–095, BEH-QD-098–101, BEH-QD-134, BEH-QD-261, INV-QD-005, INV-QD-006, INV-QD-008, INV-QD-011, INV-QD-012, INV-QD-014, INV-QD-015, INV-QD-029, ADR-QD-009 |
...
| `packages/core/test/Predicate.test.ts` | BEH-QD-121–128, BEH-QD-248, INV-QD-006, INV-QD-011, INV-QD-018, INV-QD-050, INV-QD-056 |
| `packages/core/test/Explanation.test.ts` | BEH-QD-137–143, BEH-QD-245, INV-QD-021, INV-QD-031 |
...
| `packages/predicate-sql/test/Agreement.test.ts` | BEH-QD-238, BEH-QD-241, BEH-QD-244, INV-QD-047 |
| `packages/predicate-sql/test/CompileSql.test.ts` | BEH-QD-236–240, BEH-QD-244, BEH-QD-258 |
| `packages/predicate-sql/test/Metrics.test.ts` | BEH-QD-236 |
| `packages/predicate-prisma/test/Agreement.test.ts` | BEH-QD-238, BEH-QD-239, BEH-QD-242, BEH-QD-244, INV-QD-048 |
| `packages/predicate-prisma/test/CompilePrismaWhere.test.ts` | BEH-QD-236, BEH-QD-238, BEH-QD-239, BEH-QD-244, BEH-QD-258 |
| `packages/predicate-prisma/test/MatchesPrismaWhereEngine.test.ts` | BEH-QD-239, BEH-QD-242, INV-QD-048 |
| `packages/predicate-prisma/test/Metrics.test.ts` | BEH-QD-236 |
| `packages/audit/test/AuditEntry.test.ts` | BEH-QD-250 |
| `packages/audit/test/AuditDecisionSinkLive.test.ts` | BEH-QD-249, BEH-QD-251, BEH-QD-252 |
...
| REQ-QD-027 | `features/features/port-calls/port-calls.feature` | BEH-QD-227–229, BEH-QD-261, INV-QD-005, INV-QD-006, INV-QD-044 |
