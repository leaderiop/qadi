...
| [09 — React Integration](./behaviors/09-react.md) | BEH-QD-065–071 |
...
| [18 — Policy Explanation](./behaviors/18-explanation.md) | BEH-QD-137–143 |
| [19 — Decision Hydration](./behaviors/19-hydration.md) | BEH-QD-145–150 |
| [20 — Policy Simplification](./behaviors/20-simplification.md) | BEH-QD-153–156 |
| [21 — Decision Cache](./behaviors/21-decision-cache.md) | BEH-QD-161–165 |
| [22 — The Promise Facade](./behaviors/22-promise-facade.md) | BEH-QD-169–173 |

### Decisions

Thirty-four ADRs, [indexed here](./decisions/index.yaml). The load-bearing ones:
...
All thirty-four are **Accepted** and describe code that exists. ADR-QD-018
