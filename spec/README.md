...
Thirty-two ADRs, [indexed here](./decisions/index.yaml). The load-bearing ones:
...
All thirty-two are **Accepted** and describe code that exists. ADR-QD-018
